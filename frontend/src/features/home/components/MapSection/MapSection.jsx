...
const MapSection = () => {
  // Link do Google Maps - Hotel Paradise (Maputo)
  // Substitua pelo link do seu hotel
    ...
    <section className={styles.mapSection}>
      <div className={styles.container}>
        <div className={styles.header}>
          ...
          <p className={styles.subtitle}>Venha nos visitar</p>
        </div>
        
        <div className={styles.mapWrapper}>
          <iframe
            src={mapSrc}
            title="Localização do Hotel Paradise"
